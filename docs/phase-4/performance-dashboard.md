...
|---|---|---|
| BENCH-1 selected-object drag | Release, 60 warm-up + 300 measured | p95 5.408 ms <= 16.7 ms |
| BENCH-2 cached pan | Same | p95 0.107 ms <= 16.7 ms |
| BENCH-2b forced-exposure pan | Same | p95 5.815 ms; source precondition covers 360/360 frames |
| BENCH-3 zoom / settle | Same | p95 9.162 ms <= 33 ms; settle 2.776 ms <= 100 ms |
| BENCH-4 cold full redraw | Fresh harness before scenario warm-up | 8.326 ms, informational |
