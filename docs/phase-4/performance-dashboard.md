...
committed as an informational reference. Per the 2026-07-15 Phase 5 operations
decision, hosted absolute targets remain blocking, hosted ratios are
informational, and the unchanged local owner-reference ratio remains blocking.
