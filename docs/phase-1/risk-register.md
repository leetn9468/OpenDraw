...
| R-005 | Intel behavior diverges or CI unavailable | Medium | Medium | Universal builds; real/hosted Intel test lane before release; reconsider support explicitly | Release lead |
...
| R-014 | Performance metric hardware is ambiguous | High | Medium | Nominate baseline Intel and Apple Silicon hardware in Phase 2 | Release lead |
