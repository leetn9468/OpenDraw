...
| S6 hosted operator dispatch and eight-job report | OPEN | `44f2de0`, `6208f52`, policy commit | Run #22 triage and run #23 BENCH-6 variance are retained in `hosted-run-22-triage.md` and `hosted-run-23-bench6-policy.md`; operator must dispatch the final policy revision and retain eight green jobs |
